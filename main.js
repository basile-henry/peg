...
var _user$project$Types$Outside = {ctor: 'Outside'};
var _user$project$Types$Peg = {ctor: 'Peg'};
var _user$project$Types$Empty = {ctor: 'Empty'};

var _user$project$StyleSheet$buttonStyle = F2(
		...
		return A2(
			...
			$class,
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _mdgriffith$style_elements$Style_Color$background(color),
						_1: {
							ctor: '::',
...
var _user$project$StyleSheet$DropHighlight = {ctor: 'DropHighlight'};
var _user$project$StyleSheet$CellStyle = function (a) {
	return {ctor: 'CellStyle', _0: a};
};
var _user$project$StyleSheet$BoardStyle = {ctor: 'BoardStyle'};
var _user$project$StyleSheet$Restart = {ctor: 'Restart'};
var _user$project$StyleSheet$DropDown = {ctor: 'DropDown'};
var _user$project$StyleSheet$Title = {ctor: 'Title'};
var _user$project$StyleSheet$Body = {ctor: 'Body'};
var _user$project$StyleSheet$styleSheet = _mdgriffith$style_elements$Style$styleSheet(
	{
		ctor: '::',
		_0: A2(
			_mdgriffith$style_elements$Style$style,
			_user$project$StyleSheet$Body,
			{
				ctor: '::',
				_0: _mdgriffith$style_elements$Style_Font$typeface(
					{
						ctor: '::',
						_0: _mdgriffith$style_elements$Style_Font$font('Calibri'),
						_1: {
							ctor: '::',
		...
		_1: {
			...
			_1: {
				ctor: '::',
				_0: A2(_user$project$StyleSheet$buttonStyle, _user$project$StyleSheet$DropDown, _elm_lang$core$Color$blue),
				_1: {
					ctor: '::',
					_0: A2(_user$project$StyleSheet$buttonStyle, _user$project$StyleSheet$Restart, _elm_lang$core$Color$orange),
					_1: {
						ctor: '::',
						_0: A2(
							_mdgriffith$style_elements$Style$style,
							_user$project$StyleSheet$BoardStyle,
							{ctor: '[]'}),
						_1: {
							ctor: '::',
							_0: A2(
								_mdgriffith$style_elements$Style$style,
								_user$project$StyleSheet$DropHighlight,
								{
									ctor: '::',
							...
							_1: {
								...
								_0: A2(
									_mdgriffith$style_elements$Style$style,
									_user$project$StyleSheet$CellStyle(_user$project$Types$Empty),
									{
										ctor: '::',
								...
								_1: {
									...
									_0: A2(
										_mdgriffith$style_elements$Style$style,
										_user$project$StyleSheet$CellStyle(_user$project$Types$Peg),
										{
											ctor: '::',
...
var _user$project$Board$setAt = F3(
	function (_p0, cell, board) {
		var _p1 = _p0;
		return A3(
			_elm_community$list_extra$List_Extra$updateAt,
			_p1._1,
			A2(_elm_community$list_extra$List_Extra$setAt, _p1._0, cell),
			board);
	});
var _user$project$Board$getAt = F2(
	function (_p2, board) {
		var _p3 = _p2;
		var getAtRow = F2(
			function (x, cells) {
				return A2(
					_elm_lang$core$Maybe$withDefault,
					_user$project$Types$Outside,
					A2(_elm_community$list_extra$List_Extra$getAt, x, cells));
			});
		return A2(
			_elm_lang$core$Maybe$withDefault,
			_user$project$Types$Outside,
			A2(
				_elm_lang$core$Maybe$map,
				getAtRow(_p3._0),
				A2(_elm_community$list_extra$List_Extra$getAt, _p3._1, board)));
	});
var _user$project$Board$sig = function (x) {
	return (_elm_lang$core$Native_Utils.cmp(x, 0) > 0) ? 1 : -1;
};
var _user$project$Board$validDrop = F3(
	function (board, drag, drop) {
		var emptyDrop = _elm_lang$core$Native_Utils.eq(
			A2(_user$project$Board$getAt, drop, board),
		...
		var a = _p5._0;
		var b = _p5._1;
		var skipOne = (_elm_lang$core$Native_Utils.eq(a, c) && _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$Basics$abs(b - d),
			2)) || (_elm_lang$core$Native_Utils.eq(b, d) && _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$Basics$abs(a - c),
			2));
		var overAPeg = (_elm_lang$core$Native_Utils.eq(a, c) && _elm_lang$core$Native_Utils.eq(
			A2(
				_user$project$Board$getAt,
				{
					ctor: '_Tuple2',
					_0: a,
					_1: b + _user$project$Board$sig(d - b)
				},
				board),
			_user$project$Types$Peg)) || (_elm_lang$core$Native_Utils.eq(b, d) && _elm_lang$core$Native_Utils.eq(
			A2(
				_user$project$Board$getAt,
				{
					ctor: '_Tuple2',
					_0: a + _user$project$Board$sig(c - a),
					_1: b
				},
				board),
			_user$project$Types$Peg));
		return emptyDrop && (skipOne && overAPeg);
	});
var _user$project$Board$getOverIndex = F2(
	function (_p7, _p6) {
		var _p8 = _p7;
		var _p13 = _p8._1;
		var _p12 = _p8._0;
		...
		var _p11 = _p9._1;
		var _p10 = _p9._0;
		return (_elm_lang$core$Native_Utils.eq(_p12, _p10) && _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$Basics$abs(_p11 - _p13),
			2)) ? _elm_lang$core$Maybe$Just(
			{
				ctor: '_Tuple2',
				_0: _p12,
				_1: _p13 + _user$project$Board$sig(_p11 - _p13)
			}) : ((_elm_lang$core$Native_Utils.eq(_p13, _p11) && _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$Basics$abs(_p10 - _p12),
			2)) ? _elm_lang$core$Maybe$Just(
			{
				ctor: '_Tuple2',
				_0: _p12 + _user$project$Board$sig(_p10 - _p12),
				_1: _p13
			}) : _elm_lang$core$Maybe$Nothing);
	});
var _user$project$Board$update = F2(
	function (msg, model) {
		var _p14 = msg;
		if (_p14.ctor === 'DragDrop') {
			var _p15 = A2(_norpan$elm_html5_drag_drop$Html5_DragDrop$update, _p14._0, model.dragDrop);
			var dragDrop = _p15._0;
			var result = _p15._1;
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					...
					board: function () {
						...
						if (_p16.ctor === 'Just') {
							var _p18 = _p16._0._1;
							var _p17 = _p16._0._0;
							if (A3(_user$project$Board$validDrop, model.board, _p17, _p18)) {
								var over = A2(
									_elm_lang$core$Maybe$withDefault,
									{ctor: '_Tuple2', _0: 0, _1: 0},
									A2(_user$project$Board$getOverIndex, _p17, _p18));
								return A3(
									_user$project$Board$setAt,
									_p18,
									_user$project$Types$Peg,
									A3(
										_user$project$Board$setAt,
										over,
										_user$project$Types$Empty,
										A3(_user$project$Board$setAt, _p17, _user$project$Types$Empty, model.board)));
							} else {
								return model.board;
							}
						} else {
...
var _user$project$Board$init = F2(
	function (width, board) {
		return {
			width: width,
			board: board,
			dragDrop: _norpan$elm_html5_drag_drop$Html5_DragDrop$init,
			lastDrag: {ctor: '_Tuple2', _0: 0, _1: 0}
		};
	});
var _user$project$Board$diamondBoard = {
	ctor: '::',
	_0: A2(
		_elm_lang$core$Basics_ops['++'],
		A2(_elm_lang$core$List$repeat, 4, _user$project$Types$Outside),
		A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_elm_lang$core$List$repeat, 1, _user$project$Types$Peg),
			A2(_elm_lang$core$List$repeat, 4, _user$project$Types$Outside))),
	_1: {
		ctor: '::',
		_0: A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_elm_lang$core$List$repeat, 3, _user$project$Types$Outside),
			A2(
				_elm_lang$core$Basics_ops['++'],
				A2(_elm_lang$core$List$repeat, 3, _user$project$Types$Peg),
				A2(_elm_lang$core$List$repeat, 3, _user$project$Types$Outside))),
		_1: {
			ctor: '::',
			_0: A2(
				_elm_lang$core$Basics_ops['++'],
				A2(_elm_lang$core$List$repeat, 2, _user$project$Types$Outside),
				A2(
					_elm_lang$core$Basics_ops['++'],
					A2(_elm_lang$core$List$repeat, 5, _user$project$Types$Peg),
					A2(_elm_lang$core$List$repeat, 2, _user$project$Types$Outside))),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$core$Basics_ops['++'],
					A2(_elm_lang$core$List$repeat, 1, _user$project$Types$Outside),
					A2(
						_elm_lang$core$Basics_ops['++'],
						A2(_elm_lang$core$List$repeat, 7, _user$project$Types$Peg),
						A2(_elm_lang$core$List$repeat, 1, _user$project$Types$Outside))),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$core$Basics_ops['++'],
						A2(_elm_lang$core$List$repeat, 4, _user$project$Types$Peg),
						A2(
							_elm_lang$core$Basics_ops['++'],
							{
								ctor: '::',
								_0: _user$project$Types$Empty,
								_1: {ctor: '[]'}
							},
							A2(_elm_lang$core$List$repeat, 4, _user$project$Types$Peg))),
					_1: {
...
var _user$project$Board$asymmetricalBoard = {
	ctor: '::',
	_0: A2(
		_elm_lang$core$Basics_ops['++'],
		A2(_elm_lang$core$List$repeat, 2, _user$project$Types$Outside),
	...
	_1: {
		...
		_1: {
			...
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$core$List$repeat, 8, _user$project$Types$Peg),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$core$Basics_ops['++'],
...
var _user$project$Board$englishBoard = {
	ctor: '::',
	_0: A2(
		_elm_lang$core$Basics_ops['++'],
		A2(_elm_lang$core$List$repeat, 2, _user$project$Types$Outside),
	...
	_1: {
		...
		_1: {
			ctor: '::',
			_0: A2(_elm_lang$core$List$repeat, 7, _user$project$Types$Peg),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$core$Basics_ops['++'],
...
var _user$project$Board$germanBoard = {
	ctor: '::',
	_0: A2(
		_elm_lang$core$Basics_ops['++'],
		A2(_elm_lang$core$List$repeat, 3, _user$project$Types$Outside),
	...
	_1: {
		...
		_1: {
			...
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$core$List$repeat, 9, _user$project$Types$Peg),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$core$Basics_ops['++'],
...
var _user$project$Board$frenchBoard = {
	ctor: '::',
	_0: A2(
		_elm_lang$core$Basics_ops['++'],
		A2(_elm_lang$core$List$repeat, 2, _user$project$Types$Outside),
...
var _user$project$Board$Model = F4(
	function (a, b, c, d) {
		return {width: a, board: b, dragDrop: c, lastDrag: d};
	});
var _user$project$Board$MouseDown = function (a) {
	return {ctor: 'MouseDown', _0: a};
};
var _user$project$Board$DragDrop = function (a) {
	return {ctor: 'DragDrop', _0: a};
};
var _user$project$Board$viewCell = F4(
	function (model, y, x, cell) {
		var cellWidth = A2(
			F2(
				function (x, y) {
					return x / y;
		...
		var isDrop = _elm_lang$core$Native_Utils.eq(
			dropId,
		...
		var isValidDrop = A2(
			...
			A2(
				...
				A2(
					_elm_lang$core$Maybe$map,
					A2(_user$project$Board$validDrop, model.board, model.lastDrag),
					dropId)));
		var _p19 = function () {
			var _p20 = cell;
			switch (_p20.ctor) {
				...
				case 'Empty':
					return {
						...
						_0: A2(
							peg,
							cellWidth / 10,
							isValidDrop ? _user$project$StyleSheet$DropHighlight : _user$project$StyleSheet$CellStyle(_user$project$Types$Empty)),
						_1: A2(
							_elm_lang$core$List$map,
							_mdgriffith$style_elements$Element_Attributes$toAttr,
							A2(_norpan$elm_html5_drag_drop$Html5_DragDrop$droppable, _user$project$Board$DragDrop, position))
					};
				default:
					return {
						ctor: '_Tuple2',
						...
						_1: A2(
							...
							_mdgriffith$style_elements$Element_Events$onMouseDown(
								_user$project$Board$MouseDown(position)),
							A2(
								_elm_lang$core$List$map,
								_mdgriffith$style_elements$Element_Attributes$toAttr,
								A2(_norpan$elm_html5_drag_drop$Html5_DragDrop$draggable, _user$project$Board$DragDrop, position)))
					};
			}
		}();
		var pegCell = _p19._0;
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				{
					...
					_0: _mdgriffith$style_elements$Element_Attributes$width(
						_mdgriffith$style_elements$Element_Attributes$px(cellWidth)),
					_1: {
						ctor: '::',
...
var _user$project$Board$viewRow = F3(
	function (model, y, boardRow) {
		return A3(
			...
			A2(
				_elm_lang$core$List$indexedMap,
				A2(_user$project$Board$viewCell, model, y),
				boardRow));
	});
var _user$project$Board$view = function (model) {
	return A3(
		...
		A2(
			_elm_lang$core$List$indexedMap,
			_user$project$Board$viewRow(model),
			model.board));
};

var _user$project$Main$buttonAttrs = {
	ctor: '::',
...
var _user$project$Main$title = A3(
	_mdgriffith$style_elements$Element$el,
	_user$project$StyleSheet$Title,
	{
		ctor: '::',
	...
	_mdgriffith$style_elements$Element$text('Peg Solitaire'));
var _user$project$Main$getBoard = function (boardType) {
	var _p0 = boardType;
	switch (_p0.ctor) {
		case 'French':
			return _user$project$Board$frenchBoard;
		case 'German':
			return _user$project$Board$germanBoard;
		case 'Asymmetrical':
			return _user$project$Board$asymmetricalBoard;
		case 'English':
			return _user$project$Board$englishBoard;
		default:
			return _user$project$Board$diamondBoard;
	}
};
var _user$project$Main$boardWidth = 700;
		...
		switch (_p1.ctor) {
			case 'BoardMsg':
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						board: A2(_user$project$Board$update, _p1._0, model.board)
					});
			case 'DoRestart':
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						board: A2(
							_user$project$Board$init,
							_user$project$Main$boardWidth,
							_user$project$Main$getBoard(model.boardType))
					});
			case 'DropDownToggle':
				return _elm_lang$core$Native_Utils.update(
					model,
				...
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						board: A2(
							_user$project$Board$init,
							_user$project$Main$boardWidth,
							_user$project$Main$getBoard(_p2)),
						boardType: _p2
					});
		}
	});
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {boardType: a, board: b, dropDownVisible: c};
	});
var _user$project$Main$Diamond = {ctor: 'Diamond'};
var _user$project$Main$English = {ctor: 'English'};
var _user$project$Main$Asymmetrical = {ctor: 'Asymmetrical'};
var _user$project$Main$German = {ctor: 'German'};
var _user$project$Main$French = {ctor: 'French'};
var _user$project$Main$model = {
	boardType: _user$project$Main$French,
	board: A2(_user$project$Board$init, _user$project$Main$boardWidth, _user$project$Board$frenchBoard),
	dropDownVisible: false
};
var _user$project$Main$PickBoard = function (a) {
	return {ctor: 'PickBoard', _0: a};
};
var _user$project$Main$DropDownToggle = {ctor: 'DropDownToggle'};
var _user$project$Main$boardSelection = function (model) {
	var arrow = model.dropDownVisible ? '⇡' : '⇣';
	var selection = F2(
		function (board, str) {
			return A3(
				_mdgriffith$style_elements$Element$el,
				_user$project$StyleSheet$DropDown,
				{
					...
					_0: _mdgriffith$style_elements$Element_Events$onClick(
						_user$project$Main$PickBoard(board)),
					_1: {
						ctor: '::',
						_0: _mdgriffith$style_elements$Element_Attributes$padding(5),
						_1: {ctor: '[]'}
	...
	return A2(
		...
		model.dropDownVisible ? {
			...
			_0: A3(
				...
				{
					ctor: '::',
					_0: A2(selection, _user$project$Main$French, 'French'),
					_1: {
						ctor: '::',
						_0: A2(selection, _user$project$Main$German, 'German'),
						_1: {
							ctor: '::',
							_0: A2(selection, _user$project$Main$English, 'English'),
							_1: {
								ctor: '::',
								_0: A2(selection, _user$project$Main$Asymmetrical, 'Asymmetrical'),
								_1: {
									ctor: '::',
									_0: A2(selection, _user$project$Main$Diamond, 'Diamond'),
									_1: {ctor: '[]'}
								}
							}
						}
		...
		A3(
			...
			{
				ctor: '::',
				_0: _mdgriffith$style_elements$Element_Events$onClick(_user$project$Main$DropDownToggle),
				_1: _user$project$Main$buttonAttrs
			},
			_mdgriffith$style_elements$Element$text(
				A2(_elm_lang$core$Basics_ops['++'], 'Board type ', arrow))));
};
var _user$project$Main$DoRestart = {ctor: 'DoRestart'};
var _user$project$Main$restart = A3(
	_mdgriffith$style_elements$Element$el,
	_user$project$StyleSheet$Restart,
	{
		ctor: '::',
		_0: _mdgriffith$style_elements$Element_Events$onClick(_user$project$Main$DoRestart),
		_1: _user$project$Main$buttonAttrs
	},
	_mdgriffith$style_elements$Element$text('Restart'));
var _user$project$Main$BoardMsg = function (a) {
	return {ctor: 'BoardMsg', _0: a};
};
var _user$project$Main$view = function (model) {
	var rowSpacer = A3(_mdgriffith$style_elements$Element$el, _user$project$StyleSheet$None, _user$project$Main$buttonAttrs, _mdgriffith$style_elements$Element$empty);
	var buttons = A3(
		_mdgriffith$style_elements$Element$row,
		_user$project$StyleSheet$None,
		{
		...
		{
			ctor: '::',
			_0: _user$project$Main$boardSelection(model),
			_1: {
				ctor: '::',
				_0: rowSpacer,
				_1: {
					ctor: '::',
					_0: _user$project$Main$restart,
					_1: {ctor: '[]'}
				}
			}
		});
			...
			A3(
				...
				_user$project$StyleSheet$None,
				{
					...
					_1: {
						ctor: '::',
						_0: _mdgriffith$style_elements$Element_Attributes$width(
							_mdgriffith$style_elements$Element_Attributes$px(_user$project$Main$boardWidth + 40)),
						_1: {ctor: '[]'}
					}
				},
				{
